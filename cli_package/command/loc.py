...
def count_locs(file_type, comment_pattern):
    ...
    :param file_type which file type will be search?
    :param file_type: str 
    :param comment_pattern: Escaped characters that are are comments
    :param comment_pttern: str
    """
...
def cli():
    ...
    for file_type in file_types:
        click.echo("{0}: {1}".format(file_type[0], count_locs(file_type[1], file_type[2])))
